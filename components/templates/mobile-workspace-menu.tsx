    ...
    <>
      ...
      {mounted ? (
        <div className="fixed inset-0 z-[70] lg:hidden">
          ...
          <aside
            className={cn(
              "absolute left-0 top-0 h-full w-72 max-w-[85vw] border-r border-zinc-200 bg-white p-3 shadow-[0_18px_40px_-20px_rgba(0,0,0,0.6)] transition-transform duration-200 dark:border-zinc-800 dark:bg-[#0d1012]",
          ...
          >
            ...
            <nav className="rounded-xl border border-zinc-200 bg-zinc-50 p-2 dark:border-zinc-800 dark:bg-zinc-900/70">
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive
                        ...
                        : "border-zinc-100 bg-white/60 hover:border-zinc-300/60 hover:bg-white dark:border-zinc-800 dark:bg-zinc-900/70 dark:hover:border-zinc-700 dark:hover:bg-zinc-900",
                    )}
                  >
